...
namespace RainGoo
{
    public class Tools
    {
        ...
        public static int readExistingFileCount(String ExistingFilePath)
        {
            String ExistingFile = File.ReadAllText(ExistingFilePath);
            string searchFor = "; ===================== ";
            int count = (ExistingFile.Length - ExistingFile.Replace(searchFor, "").Length) / searchFor.Length;
            return count;
